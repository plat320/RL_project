...
class ActorCritic:
	...
	def read_human_data(self):
		mat_contents = sio.loadmat('/home/seonghun/RL_project/src/turtlebot3_ddpg_collision_avoidance/turtlebot_ddpg/scripts/fd_replay/play_human_data/28_human_data.mat')
		a = mat_contents['data']
...
def main():
	...
	if train_indicator==0:
		for i in range(num_trials):
			...
			actor_critic.actor_model.load_weights("actormodel-50-500.h5")
			actor_critic.critic_model.load_weights("criticmodel-50-500.h5")
			##############################################################################################
			total_reward = 0
